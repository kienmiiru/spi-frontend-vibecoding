...
export default function RiwayatDtmPbj() {
  ...
  const handleExportDocx = async (dtm) => {
    ...
    try {
      ...
      a.href = url;
      a.download = `DTM_PBJ_${unitKerjaName}_${selectedYear}.docx`;
  ...
  const handlePreviewDocx = async (dtm) => {
    ...
    try {
      const unitKerjaName = getFacultyName(dtm.fakultasId);
      setPreviewTitle(`Pratinjau DTM PBJ - ${unitKerjaName}`);
      ...
      <div className="flex items-center justify-between border-b border-gray-300 pb-4">
        <div>
          ...
          <p className="text-xs text-gray-500 mt-1">
            Menampilkan semua DTM PBJ yang telah ditandai selesai.
          </p>
        </div>
        ...
        {isLoading ? (
                  ...
                  <Table.Cell className="text-center">
                    <div className="flex items-center justify-center gap-2">
                      <button
                        ...
                        disabled={isSaving}
                        className="inline-flex items-center gap-1 px-2.5 py-1.5 border border-gray-300 bg-white text-gray-700 hover:bg-gray-55 rounded text-xs font-medium transition-colors disabled:opacity-50"
          ...
          <div className="border border-gray-300 p-12 flex flex-col items-center justify-center text-center bg-gray-50/50">
            <span className="text-xs text-gray-400 font-semibold">
              Tidak ada riwayat DTM PBJ yang sudah ditandai selesai untuk tahun anggaran{" "}
              {selectedYear}.
            </span>
          </div>
        )}
